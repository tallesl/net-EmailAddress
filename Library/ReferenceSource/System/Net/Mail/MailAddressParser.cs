...
namespace EmailAddressValidation.ReferenceSource.System.Net.Mail
{
    ...
    public static class MailAddressParser
    {
        ...
        public static void ParseAddress(string data)
        {
            int index = data.Length - 1;
            MailAddressParser.ParseAddress(data, false, ref index);
        ...
        //
        // Throws a FormatException if any part of the MailAddress is invalid.
        private static void ParseAddress(string data, bool expectMultipleAddresses, ref int index)
        {
            ...
            {
                throw new FormatException(string.Format(SR.MailAddressInvalidFormat));
            }
            ...
            if (expectAngleBracket)
            {
                ...
                else
                {
                    ...
                    throw new FormatException(string.Format(SR.MailHeaderFieldInvalidCharacter,
        ...
        internal static string NormalizeOrThrow(string input)
        {
            ...
            {
                throw new FormatException(string.Format(SR.MailAddressInvalidFormat), argEx);
            }
        }
    }
}
